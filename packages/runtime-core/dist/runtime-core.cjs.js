...
function initProps(instance, rawProps) {
    ...
    instance.props = reactivity.reactive(props); // 属性会被变成响应式  props也可以不是响应式的
...
function setupComponent(instance) {
    ...
    if (data) {
        instance.state = reactivity.reactive(data());
    }
...
function createRenderer(options) {
    ...
    function setupRenderEffect(instance, el, anchor) {
        ...
        const effect = new reactivity.ReactiveEffect(componentUpdateFn, () => {
