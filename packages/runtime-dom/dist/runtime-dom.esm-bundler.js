...
let activeEffect = undefined; // 当前正在执行的effect 为了方便执行effect的时候依赖收集
...
export { Fragment, ReactiveEffect, Text, activeEffect, computed, createRenderer, createVNode, dowatch, effect, h, isReactive, isRef, isSameVNodeType, isVNode, proxyRefs, reactive, ref, render, shallowRef, toReactive, toRef, toRefs, track, trackEffects, trigger, triggerEffects, watch, watchEffect };
